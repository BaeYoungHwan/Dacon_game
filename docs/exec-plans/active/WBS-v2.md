...
> 프로젝트: k-stock-merchant | 작성자: 배영환 | 작성일: 2026-05-13 | 최종 업데이트: 2026-05-17 (1.10.22 정보상 국제뉴스 팝업 상하 흐름 전환 + scrollbar-cyan + 상하 여백 균형 + 도움말 풍선 입문자용 리라이팅. 이전: 1.13 뉴스 실제이벤트 교체 / 1.12 뉴스 시스템 고도화 PR #54)
